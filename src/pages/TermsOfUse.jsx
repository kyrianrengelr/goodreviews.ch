...
function TermsOfUse() {
  useEffect(() => {
    document.title = "Conditions générales d'utilisation | Good Reviews";
    const meta = document.querySelector('meta[name="description"]');
    if (meta) meta.setAttribute('content', "Conditions générales d'utilisation de la plateforme Good Reviews. Règles d'accès, fonctionnalités et obligations des utilisateurs.");
  }, []);
